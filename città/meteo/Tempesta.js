...
document.querySelectorAll("#canvasLig").forEach(el => el.remove());

// 🔵 Crea il nuovo effetto tempesta
const stormCanvas = document.createElement("canvas");
stormCanvas.id = "canvasLig";
stormCanvas.classList.add("weather-element");
...
var c = document.getElementById('canvasLig');
